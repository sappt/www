...
# w3.html용 10개 도시 (전국 + 제주)
LOCATIONS = [
    {"name": "서울", "lat": 37.5665, "lon": 126.9780, "top": 33, "left": 23},
    {"name": "춘천", "lat": 37.8813, "lon": 127.7298, "top": 23, "left": 40},
    {"name": "강릉", "lat": 37.7519, "lon": 128.8760, "top": 28, "left": 65},
    {"name": "대전", "lat": 36.3504, "lon": 127.3845, "top": 42, "left": 38},
    {"name": "대구", "lat": 35.8714, "lon": 128.6014, "top": 55, "left": 60},
    {"name": "전주", "lat": 35.8242, "lon": 127.1480, "top": 55, "left": 28},
    {"name": "광주", "lat": 35.1595, "lon": 126.8526, "top": 72, "left": 25},
    {"name": "여수", "lat": 34.7604, "lon": 127.6622, "top": 85, "left": 40},
    {"name": "부산", "lat": 35.1796, "lon": 129.0756, "top": 70, "left": 68},
    {"name": "제주", "lat": 33.4996, "lon": 126.5312, "top": 88, "left": 75}
]
    ...
    for loc in LOCATIONS:
        ...
        try:
            ...
            city_data = {
                ...
                "tempHigh": today_max,
                "tempLow": today_min,
                "type": get_weather_type(today_code),
            ...
            final_data.append({
                ...
                "tempHigh": 0, "tempLow": 0, "type": "cloudy", "weekly": []
            })
            ...
            weatherData.forEach(city => {{
                ...
                el.innerHTML = `
                    <div class="weather-svg" style="animation-delay: -${{delay}}s">
                        ${{getIconSvg(city.type)}}
                    </div>
                    <div class="info-box">
                        ${{city.name}} <span class="temp-low">${{city.tempLow}}°</span><span class="temp-separator">/</span><span class="temp-high">${{city.tempHigh}}°</span>
                    </div>
                `;
                        ...
                        city.weekly.forEach(day => {{
                            ...
                            td.innerHTML = `
                                <div class="forecast-cell">
                                    ...
                                    <div class="mini-temp"><span class="low">${{day.tempLow}}°</span>/<span class="high">${{day.tempHigh}}°</span></div>
                                </div>
                            `;
                            tr.appendChild(td);
                        }});
